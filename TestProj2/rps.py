...
imagine_hartie=PhotoImage(file=r"C:\repos\fac\MAP\TestProj2\paper.png")
...
imagine_foarfeca=PhotoImage(file=r"C:\repos\fac\MAP\TestProj2\scissors.png")
...
imagine_piatra=PhotoImage(file=r"C:\repos\fac\MAP\TestProj2\rock.png")
